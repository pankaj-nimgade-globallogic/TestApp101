...
public class MyTable109 {
     ...
     */
    private List<Column109> numberColumn;
    /**
    ...
    public MyTable109(List<Column109> numberColumn, int widthPercentage) throws
            SymmetryException {
    ...
    private void checkSymmetry() throws SymmetryException {
        ...
        for (Column109 column : this.numberColumn) {
    ...
    public void addRows(MyTable109.Row row){
        rows.add(row);
    }

    private MyTable109(int widthPercentage) {
    ...
    public List<Column109> getNumberColumn() {
        return numberColumn;
    }
    ...
    public static class Column109 {
         ...
         * @param titleOfColumn
         */
        public Column109(int widthPercentage, Paint.Align alignment, String titleOfColumn) {
            this.widthPercentage = widthPercentage;
         ...
         * @param alignment
         */
        public Column109(int widthPercentage, Paint.Align alignment) {
            this.widthPercentage = widthPercentage;
            this.alignment = alignment;
        }
