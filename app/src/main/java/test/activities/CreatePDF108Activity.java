...
public class CreatePDF108Activity extends AppCompatActivity {

    private Button pdf_Button;
    private static final String FILE_NAME = "test_108.pdf";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_create_pdf108);
        Toolbar toolbar = (Toolbar) findViewById(R.id.CreatePDF108Activity_toolbar);
    ...
    private void initializeUI() {
        pdf_Button = (Button) findViewById(R.id.CreatePDF108Activity_open_pdf_button);
        pdf_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CreatePDF108Activity.this, "Creating pdf...", Toast.LENGTH_SHORT)
                        .show();
                new CreatePDF108().execute();
            }
        });
    }


    private class CreatePDF108 extends AsyncTask<Void, Void, Void> {
        ...
        private void writeContent(PdfDocument pdfDocument) {
            int pageNumber = 0;
            do {
                pageNumber++;
