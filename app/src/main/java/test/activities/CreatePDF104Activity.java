...
public class CreatePDF104Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_pdf104);
        Toolbar toolbar = (Toolbar) findViewById(R.id.CreatePDF104Activity_toolbar);
    ...
    private void initializeUI() {
        pdf_Button = (Button) findViewById(R.id.CreatePDF104Activity_open_pdf_button);
        pdf_Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CreatePDF104Activity.this, "Creating pdf...", Toast.LENGTH_SHORT)
                        .show();
                new CreatePDF104().execute();
            }
        });
    }

    private class CreatePDF104 extends AsyncTask<Void, Void, Void> {
