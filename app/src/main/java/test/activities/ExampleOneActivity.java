...
public class ExampleOneActivity extends AppCompatActivity {
    ...
    private static final String TAG = ExampleOneActivity.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case android.R.id.home:
                ...
                Snackbar.make(findViewById(R.id.ExampleOneActivity_CoordinatorLayout), "Home clicked", Snackbar.LENGTH_LONG).show();
                break;
        }
